...
* мелодия должна состоять из сегментов, большинство из которых имеют дугообразную форму и где по мере приближения к наивысшей точке растёт напряжение, а после неё идёт спуск к стабильности.
...
* обратимый контрапункт — некоторые голоса могут быть переставлены местами друг с другом,
* структурно изменяемый контрапункт — некоторые голоса могут подвергаться инверсии и/или обращению,
