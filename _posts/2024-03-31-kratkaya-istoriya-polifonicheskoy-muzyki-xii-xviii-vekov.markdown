...
* обратимый контрапункт — некоторые голоса могут быть обращены и/или переставлены местами друг с другом,
