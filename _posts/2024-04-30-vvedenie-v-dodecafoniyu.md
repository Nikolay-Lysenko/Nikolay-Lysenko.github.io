...
Перед тем, как переходить к основному материалу, уточню, что под «тоном» в этой заметке имеется в виду звуковысотный класс, то есть нота без учёта октавы и энгармонических вариантов; например, одним и тем же тоном являются C3 и C4 или C#3 и D♭3.
